...
public class DepartmentService implements IService<Department, DepartmentDTO> {
    ...
    @Override
    public PaginatedResponse<DepartmentDTO> getAll(int page, int size, String status, String search) {
    ...
    @Override
    public PaginatedResponse<DepartmentDTO> getAllByEmployee(int page, int size, String status, String search, Long employeeId) {
