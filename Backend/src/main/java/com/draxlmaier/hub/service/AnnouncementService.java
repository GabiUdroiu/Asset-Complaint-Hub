...
public class AnnouncementService implements IService<Announcement, AnnouncementDTO> {
    ...
    @Override
    public PaginatedResponse<AnnouncementDTO> getAll(int page, int size, String status, String search) {
    ...
    @Override
    public PaginatedResponse<AnnouncementDTO> getAllByEmployee(int page, int size, String status, String search, Long employeeId) {
