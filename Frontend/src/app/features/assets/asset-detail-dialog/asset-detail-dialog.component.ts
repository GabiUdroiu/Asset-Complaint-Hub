        ...
        <div class="dialog-wrapper">
                ...
                <div class="detail-body">
                    <div class="detail-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <p>{{ asset.employeeId ? '#' + asset.employeeId : 'Unassigned (Storage)' }}</p>
                        </div>
            ...
            @if (view() === 'complaint') {
                <div class="form-body">
                    ...
                    <div class="form-actions">
                        ...
                        <button mat-raised-button color="warn" (click)="submitComplaint()" [disabled]="isSubmitting()">
            ...
            @if (view() === 'request') {
                <div class="form-body">
                    ...
                    <div class="form-actions">
                        <button mat-button (click)="view.set('detail')">Cancel</button>
                        <button mat-raised-button color="primary" (click)="submitRequest()" [disabled]="isSubmitting()">
                            <mat-icon>send</mat-icon>
                            Submit Request
                        </button>
                    </div>
