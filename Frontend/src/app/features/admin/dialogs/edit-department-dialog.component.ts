...
export class EditDepartmentDialogComponent {
    ...
    private dialogRef = inject(MatDialogRef<EditDepartmentDialogComponent>);
    private department = inject(MAT_DIALOG_DATA);

    form = {
        name: this.department?.name || '',
        responsibleEmployeeId: this.department?.responsibleEmployeeId || null as number | null,
    };
    ...
    onSubmit() {
        ...
        this.apiService.put(`departments/${this.department.id}`, payload).subscribe({
