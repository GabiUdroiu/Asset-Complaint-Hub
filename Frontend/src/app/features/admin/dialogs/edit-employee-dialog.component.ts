...
export class EditEmployeeDialogComponent {
    ...
    private employee = inject(MAT_DIALOG_DATA);

    form = {
        name: this.employee?.name || '',
        email: this.employee?.email || '',
        role: this.employee?.role || 'USER',
        departmentId: String(this.employee?.departmentId || ''),
    };
    ...
    onSubmit() {
        ...
        this.apiService.put(`employees/${this.employee.id}`, payload).subscribe({
