...
public class RequestRepository {
    ...
    public List<Request> findAllPaginated(int page, int size, String status, String search, String sortBy, String sortOrder) {
        ...
        if (status != null && !status.isEmpty()) {
            query.setParameter("status", Request.Status.valueOf(status.toUpperCase()));
        }
        if (search != null && !search.isEmpty()) {
    ...
    public List<Request> findAllByDepartmentPaginated(int page, int size, String status, String search, Long departmentId) {
        StringBuilder jpql = new StringBuilder("SELECT r FROM Request r WHERE r.employee.department.id = :departmentId");
    ...
    public long countByDepartment(String status, String search, Long departmentId) {
        StringBuilder jpql = new StringBuilder("SELECT COUNT(r) FROM Request r WHERE r.employee.department.id = :departmentId");
