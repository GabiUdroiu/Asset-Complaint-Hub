...
public class ComplaintRepository {
    ...
    public List<Complaint> findAllPaginated(int page, int size, String status, String search) {
        ...
        if (status != null && !status.isEmpty()) {
            query.setParameter("status", Complaint.Status.valueOf(status.toUpperCase()));
        }
        if (search != null && !search.isEmpty()) {
    ...
    public List<Complaint> findAllByDepartmentPaginated(int page, int size, String status, String search, Long departmentId) {
        StringBuilder jpql = new StringBuilder("SELECT c FROM Complaint c WHERE c.employee.department.id = :departmentId");
    ...
    public long countByDepartment(String status, String search, Long departmentId) {
        StringBuilder jpql = new StringBuilder("SELECT COUNT(c) FROM Complaint c WHERE c.employee.department.id = :departmentId");
