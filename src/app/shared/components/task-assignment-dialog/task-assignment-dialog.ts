...
@Component({
    ...
    template: `
        ...
        <mat-dialog-actions align="end">
            ...
            <button matButton="filled" color="primary" (click)="onAssign()" [disabled]="!form.valid">
                Assign
            </button>
        </mat-dialog-actions>
    `,
    ...
    ngOnInit() {
        ...
        this.employeeService.getEmployees().subscribe({
            next: (response: any) => {
                ...
                const responsibleUsers = allEmployees.filter((emp: EmployeeDTO) =>
                    emp.role === 'DEPT_RESPONSIBLE' || emp.role === 'ADMIN'
                );
                this.employees.set(responsibleUsers);
